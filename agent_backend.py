...
def it_agent(state: AgentState) -> AgentState:
    """IT RAG Agent: Searches IT KB, provides a solution, or escalates.Document contain issue and description with troubleshoot steps"""
...
- KB content Section wise policy information and page numbers.
- If unsure reply ONLY: ESCALATE
- Otherwise end your answer with exactly:
